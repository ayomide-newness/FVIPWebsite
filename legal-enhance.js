document.addEventListener('DOMContentLoaded', function () {
  ...
  if (!document.querySelector('.legal-footer')) {
    document.body.insertAdjacentHTML('beforeend',
      ...
      '<div><h2>Fish Valley Project</h2><a href="fish_valley_properties.html">Project Overview</a><a href="fish_valley_properties.html#development">Development</a><a href="contact.html">Sales Enquiries</a></div>' +
